...
class ToggledFrame(tk.Frame):
    ...
    def __init__(self, parent, title: str = "", *args, **options):
        ...
        self.toggle_button = ttk.Checkbutton(self.title_frame, command=self.toggle, variable=self.is_expanded, style="ToggledFrame.Toolbutton")
        ttk.Style().configure("ToggledFrame.Toolbutton", font=('Helvetica', 14), padding = (10, 10), relief="solid", borderwidth=2)
